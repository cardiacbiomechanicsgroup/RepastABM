...
if strcmp(mechanics,'UniaxC') % Greg's cryoinfarct data 2012
    errorbar(21,0.349,0.07,'o','Color','k','MarkerFaceColor','r','LineWidth',1.5);
elseif strcmp(mechanics,'Biax') % Greg's cryoinfarct data 2012
    errorbar(21,0.349,0.067,'o','Color','k','MarkerFaceColor','b','LineWidth',1.5);
elseif strcmp(mechanics,'UniaxL') % Laura's patch data 2018
    errorbar(7,0.087,(0.14-0.087),'o','Color','k','MarkerFaceColor','g','LineWidth',1.5);
    errorbar(14,0.25,(0.35-0.25),'o','Color','k','MarkerFaceColor','g','LineWidth',1.5);
    errorbar(21,0.32,(0.50-0.32),'o','Color','k','MarkerFaceColor','g','LineWidth',1.5);
    errorbar(42,0.48,(0.60-0.48),'o','Color','k','MarkerFaceColor','g','LineWidth',1.5);
end
...
%     errorbar(ExpTime,ColExpMean,ColExpSD,'o','Color','k','MarkerFaceColor','r','LineWidth',1.5);
% elseif strcmp(mechanics,'Biax')
%     errorbar(ExpTime,ColExpMean,ColExpSD,'o','Color','k','MarkerFaceColor','b','LineWidth',1.5);
% elseif strcmp(mechanics,'UniaxL') 
%     errorbar(ExpTime,ColExpMean,ColExpSD,'o','Color','k','MarkerFaceColor','g','LineWidth',1.5);
% end
end